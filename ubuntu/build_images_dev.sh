...
docker build --progress=plain --target dev -t ntadej/root-ubuntu:6.24.06-py2-dev . --build-arg PYTHON_VERSION=2 --build-arg ROOT_VERSION=6-24-06
docker build --progress=plain --target dev -t ntadej/root-ubuntu:6.24.06-py3-dev . --build-arg PYTHON_VERSION=3 --build-arg ROOT_VERSION=6-24-06
